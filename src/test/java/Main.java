...
public class Main {
    ...
    private static void inDepthDocumentCreation() throws IOException {
        ...
        BaseText t = new BaseText("Test Document", 42, f, new Position(70, 500));
        ...
        BaseText t3 = new BaseText("Written by test", 30, f, new Position(100, 200));
        BaseText t4 = new BaseText("Page 2 Test", 30, new BaseFont(FontFamily.COURIER, FontStyle.BOLDITALIC), new Position(25, 700));

        BaseParagraph p = new BaseParagraph();
        BaseParagraph p2 = new BaseParagraph(new Position(300, 200));
