...
public class ParagraphTest {
    ...
    public void testAnchor() {
        ...
        assertEquals("The given anchor could not be added on the given text and location. Only a single anchor is allowed per location.", appender.messages.get(0).getMessage().toString());
    	assertEquals(2, paragraph.getAnchors().size());
    }
