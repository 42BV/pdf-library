...
public class BaseStateTextTest {
	...
	public void setUp() {
		  ...
		  new NonStrictExpectations() {
			  {
				  ...
				  returns(new LinkedList<int[]>(Arrays.asList(new int[] {0, 30}, new int[] {79, 110})), new LinkedList<int[]>(Arrays.asList(new int[] {0, 110})));
	  ...
	  public void testAlignment(@Mocked final StatePage page) {
		  ...
		  stateText.processContentSize(page, 0, false);
		  assertEquals(2.6649999999999999, stateText.getJustificationOffset().get(new Position(0.0, -1.0)), FloatEqualityTester.EPSILON);
	  }
	  ...
	  public void testContentSizes(@Mocked final StatePage page) {
		  ...
		  assertEquals(5, stateText.getMarginLeft());	  
	  }
}
