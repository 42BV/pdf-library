...
import org.toucanpdf.pdf.structure.PdfBody;
...
public class PdfBodyTest {
    ...
    public void testAddObject() {
        ...
        Assert.assertEquals("Object has not been correctly added to the body.", test, body.getAllIndirectObjects().get(expectedObjectPos).getObject());
    }
    ...
    public void testAddPage() {
        ...
        body.addPage(page);
        int expectedObjectPos = 2;
        Assert.assertEquals("Page has not been correctly added to the body.", page, body.getAllIndirectObjects().get(expectedObjectPos).getObject());
    ...
    public void testStartByteSetting() throws IOException {
        ...
        Assert.assertEquals("The start byte is incorrect.", expectedStartByte, body.getAllIndirectObjects().get(0).getStartByte());
    }
    ...
    public void testGetIndirectObjects() {
        ...
        Assert.assertEquals("The first object was not the catalog. ", body.getCatalog(), allIndirectObjects.get(0));
