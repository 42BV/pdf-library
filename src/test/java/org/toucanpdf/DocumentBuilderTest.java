...
public class DocumentBuilderTest {
    ...
    public void testText() {
        ...
        Assert.assertEquals(1, builder.getPage(1).getContent().size());
        assertEquals("", t.getText());
    }
    ...
    public void testPage() {
        ...
        Assert.assertEquals("The new page has not been added correctly on the given position. ", testPage, builder.getPage(1));
